# Gemini Instructions: FFC-EX-PAGboosters.org

Hey Gemini! Welcome to FFC-EX-PAGboosters.org.

**Project:** FFC-EX-PAGboosters.org -- a Free For Charity nonprofit website for PAGboosters.org
...
The site deploys to `https://freeforcharity.github.io/FFC-EX-PAGboosters.org/` (and your custom domain if configured). The `assetPath()` function from `src/lib/assetPath.ts` handles this automatically.
