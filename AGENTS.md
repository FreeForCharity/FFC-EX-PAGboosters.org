# AI Agent Instructions: FFC-EX-PAGboosters.org
...
These sites deploy to `https://freeforcharity.github.io/FFC-EX-PAGboosters.org/` and optionally to a custom domain if one is configured for this repo.
