...
```
pnpm install --save keyv
```

By default everything is stored in memory, you can optionally also install a storage adapter.

```
pnpm install --save @keyv/redis
pnpm install --save @keyv/valkey
pnpm install --save @keyv/mongo
pnpm install --save @keyv/sqlite
pnpm install --save @keyv/postgres
pnpm install --save @keyv/mysql
pnpm install --save @keyv/etcd
pnpm install --save @keyv/memcache
pnpm install --save @keyv/dynamo
```
...
```bash
pnpm install --save keyv @keyv/bigmap
```
